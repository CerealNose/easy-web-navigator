...
import { Music, Image, AudioLines, Video, Download, Zap } from "lucide-react";
...
const tabs: Tab[] = [
  ...
  { id: "simple", label: "Simple Video", icon: <Zap className="w-5 h-5" />, emoji: "⚡" },
  { id: "genvid", label: "Advanced", icon: <Video className="w-5 h-5" />, emoji: "🎬" },
